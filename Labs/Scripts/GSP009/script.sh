...
then
    printf "\n\e[1;96m%s\n\n\e[m" 'Weather Data: Checkpoint Completed (1/4)'
...
# Explore New York citizen complaints data
  ...
  then
      printf "\n\e[1;96m%s\n\n\e[m" 'New York citizen complaints data: Checkpoint Completed (2/4)'
...
# Saving a new table of weather data
    ...
    then
        printf "\n\e[1;96m%s\n\n\e[m" 'New table of weather data: Checkpoint Completed (3/4)'
...
# Find correlation between weather and complaints
      ...
      then
          printf "\n\e[1;96m%s\n\n\e[m" 'Correlation between weather and complaints: Checkpoint Completed (4/4)'
      fi
    fi
  fi
printf "\n\e[1;92m%s\n\n\e[m" 'Lab Completed'
